...
int cloudMode(String command)
{
    ...
    else if(command == "prev" || command == "p" || command == "previous" ){
    ...
    else if(command == "chase" || command == "chase holiday" || ){
    ...
    else if(command == "circles" || command == "circle" || command == "circles rotate"){
    ...
    else if(command == "wave" || command == "wave spinner"){
